...
if __name__ == '__main__':
    ## 작업할 이미지 폴더 경로 설정
    img_path = r'C:\Users\bluecom015\Downloads\250.인삼 년근 판독 및 등급 식별을 위한 인공지능 학습데이터 구축\01-1.정식개방데이터\Validation\01.원천데이터\\'   # 이미지 들어있는 최상위 경로 지정
    img_list = glob(img_path + '*\\*.jpg')   # 하위 폴더들의 모든 이미지들 리스트에 넣고
    # print(len(img_list))  # 이미지 수량 체크

    # 리사이징된 이미지 들어갈 최상위 경로 지정 ** 하위 폴더 미리 만들어주세요
    dest_path = r'C:\Users\bluecom015\Downloads\Inseng'  # 마지막 \\ 생략해주세요
