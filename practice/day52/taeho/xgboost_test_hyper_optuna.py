...
if __name__ == '__main__':
    storage_dir = '../earthquake/optuna'
    study = optuna.create_study(direction='maximize', study_name="xgb_earth", storage=f'sqlite:///{storage_dir}/xgb.db')
    ...
    model_path = os.path.join(pathFolder, "xgb_optuna_best_model.pth")
